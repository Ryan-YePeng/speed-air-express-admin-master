<template>
  <div class="index" ref="index" id="index" v-title data-title="速航快运管理系统">
    <el-container>
    ...
    methods: {
      ...
      logout() {
        this.$msgBox('确定注销并退出系统吗？', 'warning').then(() => {
          // 清除缓存
          this.$removeCookiesStorage('SpeedAirExpressAdminMasterToken');
          this.$removeSessionStorage('SpeedAirExpressAdminMasterLayout');
